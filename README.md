...
- Определяет тип мышления (структурный, исследовательский и т.д.)  
- Активирует ИПМ (интеллектуальный процессор)  
- Подключает шаблон и управляет запуском мышления  
- Направляет поток в модуль итераций или прямого вывода
